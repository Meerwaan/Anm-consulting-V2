 ...
 * lui, la session expire silencieusement et le client est déconnecté en plein
 * audit. `getUser()` (et non `getSession()`) car seul le premier vérifie le
 * JWT côté serveur ; `getSession()` fait confiance au cookie.
 */
